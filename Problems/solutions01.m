...
2*diag(ones(1,4)) + 5*diag(ones(1,3),1) + 7*diag(ones(1,3),-1)
(1:4)'*ones(1,4)
...
plot((0.85+0.08*cos(24*t)).*sin(t), (0.85+0.08*cos(24*t)).*cos(t),...
    'Color', [1, 1, 1],...
    'LineWidth', 1.5)
patch(...
    'XData', 0.7*cos(s),...
...
arrayfun(@(t) circle(0.85*[cos(t), -sin(t)], 0.1), t)
arrayfun(@(t, h) text(...
    'Position', 0.85*[cos(t), -sin(t)],...
    'String', num2str(h),...
    'Color', [1, 1, 1],...
    'FontWeight', 'bold',...
    'FontName', 'Times',...
...
ydata = 0.8*[0, 1, 1, 0];
t = -2*pi*(minute/60 + second/60/60);
rot_data = rot(t, [xdata;ydata]);
xdata = rot_data(1,:);
ydata = rot_data(2,:);
patch(...
    'XData', xdata,...
