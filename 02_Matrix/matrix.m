...
%
my_rand = @(n,m,a,b) a+(b-a)*rand(n,m)
...
%% Over writing/deleting part of a matrix
clear
clc
...
%% Structural manipulation, slicing
clc
A = [11:15; 21:25; 31:35]
B = [11:14; 21:24; 31:34]
C = [11:15; 21:25]
...
rank(v*u)       % it is a 1 rank projection operator (P^2=P)
(v*u)^2/(u*v)
